...
/***/ function(module, exports, __webpack_require__) {
	...
	var _method = __webpack_require__(168);
	...
	if (process.env.NODE_ENV !== 'production') {
	  _react2.default.Perf = __webpack_require__(170);
	}

	var items = [{ title: 'URL', content: 'http://asd.com' }, { title: 'Method', content: 'ObtenerCliente' }];

	_reactDom2.default.render(_react2.default.createElement(_method2.default, { title: 'Test Method', description: 'Some description in here', apiItems: items }), document.getElementById('app'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _apiItems = __webpack_require__(169);
	...
	var method = function (_Component) {
	  ...
	  function method(props) {
	    ...
	    return _possibleConstructorReturn(this, Object.getPrototypeOf(method).call(this, props));
	  }
	  ...
	  _createClass(method, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(_apiItems2.default, { items: this.props.apiItems })
	      );
	    }
	  }]);
	...
	method.propTypes = {
	  ...
	  apiItems: _react2.default.PropTypes.array
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var apiItems = function (_Component) {
	  _inherits(apiItems, _Component);

	  function apiItems(props) {
	    _classCallCheck(this, apiItems);

	    return _possibleConstructorReturn(this, Object.getPrototypeOf(apiItems).call(this, props));
	  }

	  _createClass(apiItems, [{
	    key: 'render',
	    value: function render() {
	      var itemNode = this.props.items.map(function (item, index) {
	        return _react2.default.createElement(
	          'li',
	          { className: 'apiItem', key: index },
	          _react2.default.createElement(
	            'h2',
	            null,
	            item.title
