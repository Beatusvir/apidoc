...
/***/ function(module, exports, __webpack_require__) {
	...
	var _apis = __webpack_require__(168);
	...
	if (process.env.NODE_ENV !== 'production') {
	  _react2.default.Perf = __webpack_require__(173);
	}

	var date = new Date().getFullYear() + '-' + (new Date().getMonth() + 1) + '-' + new Date().getDay();

	var apiList = [{ title: 'CobecaAPI', description: 'Exponer servicios de transferencias bancarias con el banco Venezolano de Crédito', created: date, updated: date }, { title: 'Sitio de Clientes', description: 'Portal web para operaciones de clientes', created: date, updated: date }];

	_reactDom2.default.render(_react2.default.createElement(_apis2.default, { apiList: apiList }), document.getElementById('app'));
	...
	var Api = function (_Component) {
	  ...
	  _createClass(Api, [{
	    ...
	    value: function render() {
	      var apiNode = this.props.apiList.map(function (item, index) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".apiList {\n  display: flex;\n  flex-direction: row;\n  align-items: center;\n  align-content: center; }\n\n.apiItem {\n  flex: 0 0 200px;\n  display: flex;\n  border: 1px solid #ccc;\n  height: 400px;\n  margin-right: 30px; }\n", ""]);
